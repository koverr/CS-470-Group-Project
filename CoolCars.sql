...
VALUES
    ...
    (1987, 2, 1, 'Coupe', 'Porsche', '911 GT2 RS', 2017, 'Yellow', 210),
    (9584, 2, 3, 'Coupe', 'Porsche', '911 GT2 RS', 2018, 'Red', 200),
    (1992, 2, 1, 'Coupe', 'Porsche', '911 GT2 RS', 2015, 'Black', 270),
    (9845, 3, 1, 'Super', 'Bugatti', 'Veyron', 2012, 'Silver', 560),
    (7298, 3, 2, 'Sport', 'Toyota', 'Supra', 2017, 'Silver', 260),
    (1928, 2, 1, 'Sport', 'Toyota', 'Supra', 2016, 'Blue', 230),
    (7646, 1, 1, 'Sport', 'Toyota', 'Supra', 2019, 'Black', 290),
    (9172, 2, 1, 'Sedan', 'Mitsubishi', 'Lancer Evolution', 2016, 'Red', 50),
    (6721, 1, 3, 'Coupe', 'Ford', 'GT', 2017, 'Blue', 220),
    (6722, 2, 3, 'Coupe', 'Ford', 'GT', 2016, 'Silver', 210),
    (1826, 2, -1, 'Sport', 'Lamborghini', 'Centenario', 2017, 'Yellow', 420),
	(9374, 1, 1, 'Sport', 'Pagani', 'Zonda HP Barchetta', 2017, 'Silver', 530),
    (8176, 3,1,'Coupe','Honda','NSX',2020,'White',320),
    (9178, 3, 2,'Coupe','Porsche','918 Spyder', 2018,'Silver',400),
    (9102, 2, 2,'Sport','Ford','Mustang GT MK6', 2015,'Blue',210),
    (1092, 3, 1,'Sport','Chevrolet','Corvette ZR1', 2019,'Orange',300),
    (7382, 1, 1, 'Coupe', 'Audi', 'R8', 2012,'Red', 110),
    (9758, 3, 2, 'Coupe', 'Jaguar', 'F-TYPE', 2018,'Silver', 270),
    (7463, 1, 3, 'Coupe', 'Porsche', 'Caymen',2019, 'Silver', 310),
    (9274, 2, 1, 'Super', 'Bugatti', 'Chiron', 2019, 'Black', 2030),
    (8293, 1,1,'Coupe','Honda','NSX',2019,'Blue',300);
